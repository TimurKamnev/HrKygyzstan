...
namespace HrKyrgyzstan.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        public class InputModel
        {
            ...
            /// </summary>
            [Required]
            [StringLength(100, ErrorMessage = "The {0} must be at least {2} and at max {1}", MinimumLength = 6)]
        ...
        public async Task OnGetAsync(string returnUrl = null)
        {
            if (!await _roleManager.RoleExistsAsync(Constants.Roles.Administrator))
            {
                ...
                await _roleManager.CreateAsync(new IdentityRole(Constants.Roles.Companion));
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    //    await _userManager.AddToRoleAsync(user, Constants.Roles.Companion);
                    //    await _userManager.AddToRoleAsync(user, Constants.Roles.User);
        ...
        public class EmailDomainAttribute : ValidationAttribute
        {
            ...
            protected override ValidationResult IsValid(object value, ValidationContext validationContext)
            {
                if (value != null)
                {
                    ...
                    {
                        return new ValidationResult($"Only email addresses ending with @{allowedDomain} are allowed.");
                    }
                }
